...
(function() {
	...
	app.controller("StoreController", [ "$http", function($http) {		
		this.livres = [{
			...
			prix: 1.99,
			description: "Caucasus est un texte inquiétant signé Tiéphaine G Szuter :\n\n“Lorsqu’une expédition aussi mystérieuse que précipitée est organisée pour explorer les abimes de la Krubera-Voronja, une des grottes les plus profondes du monde, les scientifiques participants – tous russophones – se posent des questions.</p><p>Qu’y a-t-il au plus profond de ces souterrains qui ait pu piquer la curiosité du gouvernement russe ? Ce n’est que quand le chef de l’expédition, un certain Dragan Dmitrov, leur annonce qu’ils sont venus cartographier une cité ancienne enterrée là depuis des millénaires qu’ils comprennent que cette expédition pourrait bien changer leur vie à tout jamais…”</p>",
			images: {
				couv: "1_couv.jpg",
				auteur: "1_auteur.jpg"
			}
