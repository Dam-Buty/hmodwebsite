...
(function() {
	...
	app.controller("StoreController", [ "$http", function($http) {		
		...
		this.current = this.livres[0];
		
		this.setCurrent = function(index) {
			this.current = this.livres[index];
		};
		
		this.getCouv = function(id) {
			return "assets/" + id + "_couv.jpg";
		};
		
		this.getAuteur = function(id) {
			return "assets/" + id + "_auteur.jpg";
		};
		
		this.getThumb = function(id) {
			return "assets/" + id + "_thumb.jpg";
		};
	}]);
